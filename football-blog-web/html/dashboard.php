...
<body>
  <div id="welcomeOverlay" class="overlay">
    <div class="welcome-box">
      <span class="closebtn" onclick="closeWelcome()">&times;</span>
      <h2>Hello, <?php echo htmlspecialchars($_SESSION['username']); ?>! </h2>
      <p>Welcome to Footy.</p>
      <p>Here you can see the latest news about Football and top 5 biggest league standings.</p>
    </div>
  </div>
