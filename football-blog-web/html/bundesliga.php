...
if (!file_exists($cacheFolder)) {
    if (!mkdir($cacheFolder, 0755, true)) die("Failed to create cache folder: $cacheFolder");
}

$rss_url = "https://bulinews.com/rss.xml";
$cacheFileRSS = "$cacheFolder/bundesliga_rss.json";
$cacheTimeRSS = 5 * 60; 
...
if (file_exists($cacheFileRSS) && time() - filemtime($cacheFileRSS) < $cacheTimeRSS) {
    $data = json_decode(file_get_contents($cacheFileRSS), true);
} else {
    ...
    file_put_contents($cacheFileRSS, json_encode($data));
}

$newsItems = array_slice($data, 0, 5);

$apiKey = "063f0699e14d434b94fbaa277a38e2f2";
$cacheFileStandings = __DIR__ . "/cache/BL1_standings.json";
...
if (file_exists($cacheFileStandings) && time() - filemtime($cacheFileStandings) < $cacheTimeStandings) {
    ...
    $ch = curl_init("https://api.football-data.org/v4/competitions/BL1/standings");
...
<div class="dashboard-content">
    ...
    <div class="bigbox">
        <div class="news-container">
            <h2>⚽ Bundesliga Latest News</h2>
            <div class="news-list">
                <?php if(empty($newsItems)): ?>
                    <p>No Bundesliga news available at the moment.</p>
                <?php else: ?>
                    <ul>
        ...
        <div class="box2">
            <div class="standings-container">
                <h2>🏆 Bundesliga League Standings</h2>
