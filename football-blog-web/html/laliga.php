...
$rss_url = "https://football-espana.net/category/la-liga/feed";
$cacheFile = "$cacheFolder/laliga_rss.json"; 
$cacheTime = 5*60; 
...
$cacheFile = __DIR__ . "/cache/PD_standings.json"; 
$cacheTime = 15 * 60; 
...
if (file_exists($cacheFile) && time() - filemtime($cacheFile) < $cacheTime) {
    ...
    $ch = curl_init("https://api.football-data.org/v4/competitions/PD/standings");
...
<div class="dashboard-content">
  ...
  <!-- NEWS AND STANDINGS -->
        <div class="news-container">
            <h2>⚽ La Liga Latest News</h2>
            <div class="news-list">
                <?php if (empty($newsItems)): ?>
                    <p>No La Liga news available at the moment.</p>
                <?php else: ?>
                    <ul>
